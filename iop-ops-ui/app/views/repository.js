                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        "render": function (data) {
                            return App.statusLabel("repository:"+data);
                        }
                    },
                    {
                        "data": {},
            ...
            Modal.show({
                ...
                buttons: [{
                    ...
                    action: function (dialog) {
                        ...
                        self.ajax.post("v1/resource/repository", repository, function (err, data) {
                            if (err) {
            ...
            Modal.confirm({
                ...
                callback: function (result) {
                    if (result) {
                        ...
                        self.ajax.delete("v1/resource/repository/" + id, function (err, data) {
                            if (data) {
